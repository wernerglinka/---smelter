import { transformFormElementsToObject, ValueOps, PathOps, FormStateOps } from '@lib/form-submission/transform-form-to-object';
  ...
  describe('transformFormElementsToObject', () => {
    ...
    test('should handle errors gracefully', () => {
      ...
      const elements = [
        { 
          classList: { 
            contains: () => { throw new Error('Test error'); } 
          } 
        }
      ];
