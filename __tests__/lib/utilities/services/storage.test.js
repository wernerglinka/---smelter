...
describe('StorageOperations', () => {
  ...
  describe('full project data operations', () => {
    ...
    test('saveProjectData saves all paths', () => {
      ...
      expect(localStorageMock.setItem).toHaveBeenCalledWith('projectFolder', testProjectData.projectPath);
      expect(localStorageMock.setItem).toHaveBeenCalledWith('contentFolder', testProjectData.contentPath);
