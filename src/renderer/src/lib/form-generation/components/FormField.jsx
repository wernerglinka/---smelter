...
export const FormField = ({
      ...
      <ObjectField
        ...
        onDuplicate={
          onFieldDuplicate
            ? () => {
                console.log(
                  'FormField: Trying to duplicate object:',
                  field.id,
                  'parent:',
                  field.parentId
                );
        ...
        onDelete={
          onFieldDelete
            ? () => {
                console.log(
                  'FormField: Trying to delete object:',
                  field.id,
                  'parent:',
                  field.parentId
                );
      ...
      <ArrayField
        ...
        onDuplicate={
          onFieldDuplicate
            ? () => {
                console.log(
                  'FormField: Trying to duplicate array:',
                  field.id,
                  'parent:',
                  field.parentId
                );
        ...
        onDelete={
          onFieldDelete
            ? () => {
                console.log(
                  'FormField: Trying to delete array:',
                  field.id,
                  'parent:',
                  field.parentId
                );
  ...
  const props = {
    ...
    onDuplicate: onFieldDuplicate
      ? () => {
          console.log(
            'FormField: Trying to duplicate basic field:',
            field.id,
            'parent:',
            field.parentId
          );
    ...
    onDelete: onFieldDelete
      ? () => {
          console.log(
            'FormField: Trying to delete basic field:',
            field.id,
            'parent:',
            field.parentId
          );
