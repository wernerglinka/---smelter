  ...
  return (function e(t, n, i) {
  ...
  })(
    {
        ...
        function (e, t, n) {
          (function (e) {
            ...
            e.defineOption('autoRefresh', !1, function (n, i) {
              n.state.autoRefresh && (t(0, n.state.autoRefresh), (n.state.autoRefresh = null)),
                i &&
                  ...
                  (function (n, i) {
                    function r() {
                      n.display.wrapper.offsetHeight
                        ? (t(0, i),
                          n.display.lastWrapHeight != n.display.wrapper.clientHeight && n.refresh())
          ...
          (function (e) {
            ...
            function r(e) {
              var i = e.getWrapperElement(),
                r = o(e);
              (i.className =
                i.className.replace(' CodeMirror-empty', '') + (r ? ' CodeMirror-empty' : '')),
                r ? n(e) : t(e);
            }
            function o(e) {
              ...
              for (var a = o.listSelections(), l = [], s = 0; s < a.length; s++) {
                ...
                if (n.test(p)) {
                  var v = f && />\s*$/.test(p),
                    x = !/>\s*$/.test(p);
                  (v || x) &&
                    o.replaceRange('', { line: u.line, ch: 0 }, { line: u.line, ch: u.ch + 1 }),
                    (l[s] = '\n');
                } else {
                  var y = m[1],
                    b = m[5],
          ...
          (function (e) {
            ...
            e.overlayMode = function (t, n, i) {
              return {
                ...
                token: function (e, r) {
                  return (
                    (e != r.streamSeen || Math.min(r.basePos, r.overlayPos) < e.start) &&
          ...
          (function (e) {
            ...
            function a(e, t, n) {
              ...
              for (var o = n.line, a = n.ch, l = e.lastLine(); o <= l; o++, a = 0) {
                ...
                var s = e.getLine(o),
                  u = t.exec(s);
                if (u) return { from: i(o, u.index), to: i(o, u.index + u[0].length), match: u };
              }
            }
            function l(e, t, n) {
            ...
            function u(e, t, n) {
              ...
              for (var o = n.line, a = n.ch, l = e.firstLine(); o >= l; o--, a = -1) {
                ...
                if (c) return { from: i(o, c.index), to: i(o, c.index + c[0].length), match: c };
              }
            }
            function c(e, t, n) {
              ...
              t = r(t, 'gm');
              for (
                var a, l = 1, c = e.getLine(n.line).length - n.ch, d = n.line, h = e.firstLine();
                d >= h;
            ...
            function h(e, r, o, a) {
              ...
              e: for (
                ...
                if (1 == s.length) {
                  ...
                  return (
                    (o = d(f, p, m, l) + c),
                    { from: i(u, d(f, p, m, l) + c), to: i(u, d(f, p, m + s[0].length, l) + c) }
                  );
                }
            ...
            function f(e, r, o, a) {
              ...
              e: for (
                ...
                if (1 == s.length) {
                  ...
                  if (-1 == m) continue e;
                  return { from: i(u, d(f, p, m, l)), to: i(u, d(f, p, m + s[0].length, l)) };
                }
                var g = s[s.length - 1];
            ...
            String.prototype.normalize
              ...
              (p.prototype = {
                ...
                find: function (t) {
                  ...
                  if (
                    ...
                    t
                      ? (n.ch--,
                        n.ch < 0 && (n.line--, (n.ch = (this.doc.getLine(n.line) || '').length)))
                      : (n.ch++,
                  ...
                  if (((this.afterEmptyMatch = r && 0 == e.cmpPos(r.from, r.to)), r))
              ...
              e.defineExtension('selectMatches', function (t, n) {
                for (
                  var i = [], r = this.getSearchCursor(t, this.getCursor('from'), n);
        ...
        function (e, t, n) {
          (function (e) {
            ...
            function o(e, t, n, o) {
              if (0 != r(t, n))
                for (
                  var a = e.state.markedSelection, l = e.state.markedSelectionStyle, s = t.line;
                  ;
        ...
        function (e, t, n) {
          !(function (e, i) {
            ...
            function T(e, t, n, i) {
              ...
              if ((n && (r.className = n), i && (r.style.cssText = i), 'string' == typeof t))
              ...
              return function (a, l) {
                ...
                for (var C = 0; C < c; ++C) {
                  ...
                  if (',' == w) d[C] = 'N';
                    ...
                    for (k = C + 1; k < c && '%' == d[k]; ++k);
                    for (
                      var S = (C && '!' == d[C - 1]) || (k < c && '1' == d[k]) ? '1' : 'N', F = C;
                      F < k;
                      ++F
                    )
                      d[F] = S;
                ...
                return (
                  'ltr' == l &&
                    (1 == z[0].level &&
                      (I = a.match(/^\s+/)) &&
                      ((z[0].from = I[0].length), z.unshift(new o(0, 0, I[0].length))),
                    1 == Y(z).level &&
                      (I = a.match(/\s+$/)) &&
                      ((Y(z).to -= I[0].length), z.push(new o(0, c - I[0].length, c)))),
                  'rtl' == l ? z.reverse() : z
                );
              };
            })();
              ...
              if (null == Ee) {
                ...
                L(e, T('span', [t, document.createTextNode('x')])),
                  0 != e.firstChild.offsetHeight &&
                    (Ee = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(a && l < 8));
              }
              var n = Ee
                ? T('span', '​')
            ...
            var Ne,
              ...
              ze =
                'oncopy' in (Ne = T('div')) ||
                (Ne.setAttribute('oncopy', 'return;'), 'function' == typeof Ne.oncopy),
              He = null;
            var Re = {},
              Pe = {};
            function _e(e, t) {
            ...
            function We(e) {
              if ('string' == typeof e && Pe.hasOwnProperty(e)) e = Pe[e];
                ...
                var t = Pe[e.name];
                'string' == typeof t && (t = { name: t }), ((e = ee(t, e)).name = t.name);
              } else {
            ...
            function gt(e, t, n) {
              ...
              var o = (function (e, t, n) {
                  for (
                    var i, r, o = e.doc, a = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), l = t;
                    l > a;
                    --l
                  ) {
              ...
              return (
                i.iter(o, t, function (n) {
                  ...
                  var i = l.line;
                  (n.stateAfter =
                    i == t - 1 || i % 5 == 0 || (i >= r.viewFrom && i < r.viewTo)
                      ? l.save()
                      : null),
                    l.nextLine();
                }),
            ...
            function vt(e, t, n, i) {
              ...
              for (o.start = o.pos = i || 0, '' == t && xt(r, n.state); !o.eol(); )
              ...
              for ('' == t && Ct(xt(n, i.state), o); !d.eol(); ) {
                if (
                  (d.pos > e.options.maxHighlightLength
                    ? ((l = !1), a && vt(e, t, i, d.pos), (d.pos = t.length), (s = null))
                  ...
                  if (e)
                    for (var r = 0; r < e.length; ++r) {
                      ...
                      if (
                        ...
                        (i || (i = [])).push(
                          new Ft(a, l ? null : o.from - t, null == o.to ? null : o.to - t)
                        );
                      }
                    }
                  return i;
              ...
              if (s)
                for (var p = 0; p < s.length; ++p) {
                  ...
                  if ((null != m.to && (m.to += c), null == m.from))
                    At(l, m.marker) || ((m.from = c), u && (l || (l = [])).push(m));
                ...
                (i.pos = 0),
                  ...
                  o.styleClasses &&
                    ...
                    o.styleClasses.textClass &&
                      (i.textClass = I(o.styleClasses.textClass, i.textClass || ''))),
                  0 == i.map.length &&
                    i.map.push(0, 0, i.content.appendChild(Me(e.display.measure))),
                  0 == r
              ...
              if (t) {
                ...
                if (d.test(t)) {
                  ...
                  for (var f = 0; ; ) {
                    ...
                    if ('\t' == p[0]) {
                      var x = e.cm.options.tabSize,
                        y = x - (e.col % x);
                      (v = u.appendChild(T('span', Z(y), 'cm-tab'))).setAttribute(
                        'role',
                        'presentation'
                      ),
                  ...
                  (e.col += t.length),
                    ...
                    (e.pos += t.length);
                if (
                  ((e.trailingSpace = 32 == c.charCodeAt(t.length - 1)), n || i || r || h || o || s)
                ) {
                  var b = n || '';
                  i && (b += i), r && (b += r);
                  var D = T('span', [u], b, o);
                  ...
                  if (v == p) {
                    ...
                    for (var x = [], y = void 0, b = 0; b < i.length; ++b) {
                      ...
                      if ('bookmark' == C.type && D.from == p && C.widgetNode) x.push(C);
                        ...
                        D.from <= p &&
                        (null == D.to || D.to > p || (C.collapsed && D.to == p && D.from == p))
                      ) {
                        if (
                          (null != D.to && D.to != p && v > D.to && ((v = D.to), (u = '')),
                    ...
                    if (y) for (var k = 0; k < y.length; k += 2) y[k + 1] == v && (u += ' ' + y[k]);
                    if (!d || d.from == p) for (var S = 0; S < x.length; ++S) on(t, 0, x[S]);
                    if (d && (d.from || 0) == p) {
                      if (
                        (on(t, (null == d.to ? f + 1 : d.to) - p, d.marker, null == d.from),
                        null == d.to)
                      )
                        return;
                      d.to == p && (d = !1);
            ...
            function gn(e, t) {
              ...
              t.text == t.node && (t.node = i.pre),
                ...
                i.bgClass != t.bgClass || i.textClass != t.textClass
                  ? ((t.bgClass = i.bgClass), (t.textClass = i.textClass), vn(e, t))
                    ...
                    c &&
                      l.appendChild(
                        T(
                          ...
                          'left: ' + i.gutterLeft[u] + 'px; width: ' + i.gutterWidth[u] + 'px'
                        )
                      );
                  }
              }
            ...
            function yn(e, t, n) {
              ...
              for (var i = S('CodeMirror-linewidget'), r = t.node.firstChild, o = void 0; r; r = o)
                (o = r.nextSibling), i.test(r.className) && t.node.removeChild(r);
              Dn(e, t, n);
            }
            function bn(e, t, n, i) {
              var r = mn(e, t);
            ...
            function wn(e, t, n, i) {
              if (e.noHScroll) {
                ...
                (t.style.left = i.fixedPos + 'px'),
                  e.coverGutter ||
                    ((r -= i.gutterTotalWidth), (t.style.paddingLeft = i.gutterTotalWidth + 'px')),
                  (t.style.width = r + 'px');
              }
              e.coverGutter &&
                ((t.style.zIndex = 5),
            ...
            function In(e, t) {
              ...
              i && !i.text
                ? (i = null)
                : i && i.changes && (fn(e, i, n, si(e)), (e.curOp.forceUpdate = !0)),
                i ||
                  (i = (function (e, t) {
                    var n = Je((t = Wt(t))),
            ...
            function _n(e, t) {
              var n = Rn;
              if ('left' == t) for (var i = 0; i < e.length && (n = e[i]).left == n.right; i++);
              else for (var r = e.length - 1; r >= 0 && (n = e[r]).left == n.right; r--);
              return n;
            }
            function Wn(e) {
            ...
            function Gn(e) {
              var t = Wt(e).widgets,
                n = 0;
              if (t) for (var i = 0; i < t.length; ++i) t[i].above && (n += kn(t[i]));
              return n;
            }
            function Vn(e, t, n, i, r) {
              ...
              var a = Gt(t);
              if (
                ('local' == i ? (a += Fn(e.display)) : (a -= e.display.viewOffset),
                'page' == i || 'window' == i)
              ) {
                ...
                g = se(
                  function (t) {
                    ...
                    return (
                      (n.top += a),
                      (n.bottom += a),
                      !!ni(n, i, r, !1) && (n.top <= r && n.left <= i && ((p = t), (m = n)), !0)
                    );
                  },
                  l,
                  s
              ...
              var l = se(
                  function (l) {
                    var s = r[l],
                      u = 1 != s.level;
                    return ni(
                      Zn(e, it(n, u ? s.to : s.from, u ? 'before' : 'after'), 'line', t, i),
                      o,
                      a,
                      !0
                    );
            ...
            function ai(e) {
              ...
              if (null == Hn) {
                ...
                for (var t = 0; t < 49; ++t)
                  Hn.appendChild(document.createTextNode('x')), Hn.appendChild(T('br'));
            ...
            function hi(e, t, n, i) {
              ...
              if (i && u.xRel > 0 && (s = Ke(e.doc, u.line).text).length == u.ch) {
                ...
                u = it(
                  u.line,
                  Math.max(0, Math.round((o - En(e.display).left) / li(e.display)) - c)
                );
              }
              return u;
            }
            ...
            function pi(e, t, n, i) {
              ...
              if (
                ...
                St && qt(e.doc, n + i) > r.viewFrom ? gi(e) : ((r.viewFrom += i), (r.viewTo += i));
              else if (t <= r.viewFrom && n >= r.viewTo) gi(e);
              else if (t <= r.viewFrom) {
                var o = vi(e, n, n + i, 1);
                o
                  ? ((r.view = r.view.slice(o.index)), (r.viewFrom = o.lineN), (r.viewTo += i))
                  : gi(e);
              } else if (n >= r.viewTo) {
                var a = vi(e, t, t, -1);
            ...
            function mi(e, t, n) {
              ...
              if (
                (r && t >= r.lineN && t < r.lineN + r.size && (i.externalMeasured = null),
            ...
            function wi(e, t, n) {
              ...
              function d(t, n, i) {
                ...
                function p(t, n, i) {
                  ...
                  return f(
                    'after' == i ? r.begin : r.end - (/\s/.test(d.text.charAt(r.end - 1)) ? 2 : 1),
                    o
                  )[o];
                }
                  ...
                  (function (e, t, n, i) {
                    ...
                    for (var r = !1, o = 0; o < e.length; ++o) {
                      ...
                      ((a.from < n && a.to > t) || (t == n && a.to == t)) &&
                        (i(Math.max(a.from, t), Math.min(a.to, n), 1 == a.level ? 'rtl' : 'ltr', o),
                        (r = !0));
                    }
                    r || i(t, n, 'ltr');
              ...
              if (h.line == f.line) d(h.line, h.ch, f.ch);
                ...
                g &&
                  (v.top < x.top - 2
                    ? (c(v.right, v.top, null, v.bottom), c(l, x.top, x.left, x.bottom))
              ...
              (e.state.delayingBlurEvent = !0),
                setTimeout(function () {
                  e.state.delayingBlurEvent &&
                    ((e.state.delayingBlurEvent = !1), e.state.focused && Ei(e));
                }, 100);
            }
            function Ai(e, t) {
              e.state.delayingBlurEvent &&
            ...
            function Mi(e, t, n) {
              ...
              if (n && n.ensure) {
                var l = n.ensure.from.line,
                  s = n.ensure.to.line;
                l < o
                  ? ((o = l), (a = et(t, Gt(Ke(t, l)) + e.wrapper.clientHeight)))
                  : Math.min(s, t.lastLine()) >= a &&
                    ((o = et(t, Gt(Ke(t, s)) - e.wrapper.clientHeight)), (a = s));
              }
            ...
            function Bi(e, t) {
              ...
              t.top < 0 && (t.top = 0);
              var r =
                  e.curOp && null != e.curOp.scrollTop ? e.curOp.scrollTop : n.scroller.scrollTop,
                o = Mn(e),
                a = {};
              ...
              return (
                ...
                t.left < 10
                  ...
                  : t.left < h
                    ...
                    : t.right > f + h - 3 && (a.scrollLeft = t.right + (p ? 0 : 10) - f),
                a
              );
            }
            function Ni(e, t) {
            ...
            function _i(e, t, n, i) {
              (t = Math.max(
                ...
                ((n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !i) ||
                  ((e.doc.scrollLeft = t),
                  mr(e),
                ...
                (e.style.visibility = ''),
                  t.set(1e3, function i() {
                    ...
                    ('vert' == n
                      ...
                      : document.elementFromPoint((r.right + r.left) / 2, r.bottom - 1)) != e
            ...
            function $i(e, t) {
              ...
              (n.sizer.style.paddingRight = (n.barWidth = i.right) + 'px'),
                ...
                i.bottom && e.options.coverGutterNextToScrollbar && e.options.fixedGutter
            ...
            function Ki(e) {
              ...
              (e.curOp = {
                ...
                (t = e.curOp),
                un ? un.ops.push(t) : (t.ownsGroup = un = { ops: [t], delayedCallbacks: [] });
            }
            function Zi(e) {
              var t = e.curOp;
              t &&
            ...
            function Ji(e) {
              ...
              e.updatedDisplay && Li(t),
                ...
                n.maxLineChanged &&
                  ...
                  ((e.adjustWidthTo = Nn(t, n.maxLine, n.maxLine.text.length).left + 3),
                  (t.display.sizerWidth = e.adjustWidthTo),
                  (e.barMeasure.scrollWidth = Math.max(
                    n.scroller.clientWidth,
                    n.sizer.offsetLeft + e.adjustWidthTo + Ln(t) + t.display.barWidth
                  )),
            ...
            function er(e) {
              ...
              null != e.adjustWidthTo &&
                ...
                e.maxScrollLeft < t.doc.scrollLeft &&
                  _i(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
              ...
              if (
                ...
                var r = (function (e, t, n, i) {
                  ...
                  for (var o = 0; o < 5; o++) {
                    ...
                    if (
                      (null != u.scrollTop &&
                        (Ri(e, u.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (a = !0)),
                      null != u.scrollLeft &&
                        (_i(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - d) > 1 && (a = !0)),
                      !a)
                    )
                      break;
                  }
                ...
                (function (e, t, n) {
                  ...
                  for (var u = i.view, c = i.viewFrom, d = 0; d < u.length; d++) {
                    ...
                    if (h.hidden);
                      ...
                      h.changes && (q(h.changes, 'gutter') > -1 && (f = !1), fn(e, h, c, n)),
                        f &&
                          (E(h.lineNumber),
            ...
            function dr(e, t) {
              for (var n = t.viewport, i = !0; ; i = !1) {
                if (i && e.options.lineWrapping && t.oldDisplayWidth != Tn(e))
                  ...
                  (n &&
                    null != n.top &&
                    (n = { top: Math.min(e.doc.height + An(e.display) - Mn(e), n.top) }),
            ...
            function gr(e) {
              ...
              if (n.length != i.lineNumChars) {
                var r = i.measure.appendChild(
                    T('div', [T('div', n)], 'CodeMirror-linenumber CodeMirror-gutter-elt')
                  ),
            ...
            function vr(e, t) {
              ...
              return t && !i && n.push({ className: 'CodeMirror-linenumbers', style: null }), n;
            }
            function xr(e) {
              var t = e.gutters,
                n = e.gutterSpecs;
            ...
            a ? (Cr = -0.53) : n ? (Cr = 15) : c ? (Cr = -0.7) : f && (Cr = -1 / 3);
            var Fr = function (e, t) {
            ...
            function jr(e, t) {
              var n = { from: at(t.from), to: Tr(t), text: Ze(e, t.from, t.to) };
              return (
              ...
              if (
                (r.lastOp == i ||
                  (r.lastOrigin == t.origin &&
                    t.origin &&
                    (('+' == t.origin.charAt(0) &&
                      r.lastModTime > l - (e.cm ? e.cm.options.historyEventDelay : 500)) ||
                      '*' == t.origin.charAt(0)))) &&
                (o = (function (e, t) {
                  return t
                    ? (qr(e.done), Y(e.done))
            ...
            function oo(e, t) {
              t.equals(e.sel) ||
                ((e.sel = t),
                e.cm &&
                  ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), ye(e.cm)),
                  ...
                  if (
                    ...
                    if (n) {
                      var d = s.find(i < 0 ? 1 : -1),
                        h = void 0;
                      if (
                        ((i < 0 ? c : u) && (d = co(e, d, -i, d && d.line == t.line ? o : null)),
                    ...
                    return (
                      (i < 0 ? u : c) && (f = co(e, f, i, f.line == t.line ? o : null)),
                      f ? so(e, f, t, i, r) : null
                    );
                  }
                }
            ...
            function mo(e, t) {
              if (1 != t.text.length || '' != t.text[0] || 0 != rt(t.from, t.to)) {
                ...
                var i = [];
                Rr(e, function (e, n) {
                  n || -1 != q(i, e.history) || (Co(e.history, t), i.push(e.history)),
                    xo(e, t, null, Lt(e, t));
                });
              }
            }
              ...
              if (!i || n) {
                for (
                  var r,
                    ...
                    u = 0;
                  u < l.length && ((r = l[u]), n ? !r.ranges || r.equals(e.sel) : r.ranges);
                  u++
                );
                if (u != l.length) {
                  for (o.lastOrigin = o.lastSelOrigin = null; ; ) {
                    ...
                    if ((Gr(r, s), n && !r.equals(e.sel))) return void io(e, r, { clearRedo: !1 });
                    a = r;
                  }
                  var c = [];
                  Gr(a, s),
                  ...
                  for (
                    var d = be(e, 'beforeChange') || (e.cm && be(e.cm, 'beforeChange')),
                      h = function (n) {
                        var i = r.changes[n];
                        ...
                        var o = n ? Br(e, i) : Y(l);
                        xo(e, i, o, Kr(e, i)),
                          !n && e.cm && e.cm.scrollIntoView({ from: i.from, to: Tr(i) });
                        var a = [];
                        Rr(e, function (e, t) {
                          t || -1 != q(a, e.history) || (Co(e.history, i), a.push(e.history)),
                            xo(e, i, null, Kr(e, i));
                        });
                      },
                ...
                t.to.line > o &&
                  ...
                  e.cm
                    ? (function (e, t, n) {
                        ...
                        t.full
                          ? pi(e)
                          : o.line != a.line || 1 != t.text.length || zr(e.doc, t)
              ...
              for (var r = 0; r < e.length; ++r) {
                ...
                if (o.ranges) {
                  ...
                  for (var l = 0; l < o.ranges.length; l++)
                    bo(o.ranges[l].anchor, t, n, i), bo(o.ranges[l].head, t, n, i);
                } else {
            ...
            (Ar.prototype.from = function () {
              ...
              (So.prototype = {
                ...
                removeInner: function (e, t) {
                  ...
                  if (
                    this.size - t < 25 &&
                    (this.children.length > 1 || !(this.children[0] instanceof ko))
                  ) {
                    var l = [];
                    this.collapse(l),
            ...
            function To(e, t, n, i, r) {
              ...
              o.addToHistory && Ur(e, { from: t, to: n, origin: 'markText' }, e.sel, NaN);
              var l,
                s = t.line,
                u = e.cm;
              if (
                (e.iter(s, n.line + 1, function (i) {
                  u &&
                    ...
                    (function (e, t, n) {
                      ...
                      i,
                      new Ft(o, s == t.line ? t.ch : null, s == n.line ? n.ch : null),
                      e.cm && e.cm.curOp
                    ),
                    ++s;
                }),
            ...
            (Lo.prototype.clear = function () {
              if (!this.explicitlyCleared) {
                ...
                for (var i = null, r = null, o = 0; o < this.lines.length; ++o) {
                  ...
                  e && !this.collapsed
                    ? mi(e, Je(a), 'text')
                    : e && (null != l.to && (r = Je(a)), null != l.from && (i = Je(a))),
                ...
                null != i && e && this.collapsed && pi(e, i, r + 1),
                  ...
                  this.atomic && this.doc.cantEdit && ((this.doc.cantEdit = !1), e && ao(e.doc)),
                ...
                t &&
                  ...
                  nr(i, function () {
                    var r = t.line,
                      ...
                      a = On(i, o);
                    if (
                      (a && (Wn(a), (i.curOp.selectionChanged = i.curOp.forceUpdate = !0)),
              ...
              for (
                var t = function (t) {
                    ...
                    for (var r = 0; r < n.markers.length; r++) {
                      var o = n.markers[r];
                      -1 == q(i, o.doc) && ((o.parent = null), n.markers.splice(r--, 1));
                    }
                  },
                  n = 0;
                n < e.length;
            ...
            (Io.prototype = ee(So.prototype, {
              ...
              removeLineClass: or(function (e, t, n) {
                return wo(this, e, 'gutter' == t ? 'gutter' : 'class', function (e) {
                  ...
                  if (null == n) e[i] = null;
                    ...
                    var a = o.index + o[0].length;
                    e[i] =
                      r.slice(0, o.index) + (o.index && a != r.length ? ' ' : '') + r.slice(a) ||
                      null;
                  }
                  return !0;
                });
                  ...
                  return (
                    ...
                    wo(e, t, 'widget', function (t) {
                      ...
                      if (
                        (null == r.insertAt
                          ? n.push(r)
                          : n.splice(Math.min(n.length, Math.max(0, r.insertAt)), 0, r),
                        (r.line = t),
                        o && !Ut(e, t))
                      ) {
              ...
              linkedDoc: function (e) {
                ...
                return (
                  ...
                  (this.linked || (this.linked = [])).push({ doc: i, sharedHist: e.sharedHist }),
                  (i.linked = [{ doc: this, isParent: !0, sharedHist: e.sharedHist }]),
                  (function (e, t) {
                    for (var n = 0; n < t.length; n++) {
                      var i = t[n],
                        r = i.find(),
            ...
            function Po(e) {
              if (document.getElementsByClassName) {
                for (
                  var t = document.getElementsByClassName('CodeMirror'), n = [], i = 0;
                  i < t.length;
                  i++
                ) {
            ...
            var oa = {
              ...
              deleteLine: function (e) {
                return ta(e, function (t) {
                  return { from: it(t.from().line, 0), to: ct(e.doc, it(t.to().line + 1, 0)) };
                });
              },
                ...
                return nr(e, function () {
                  for (var t = e.listSelections(), n = [], i = 0; i < t.length; i++)
                    if (t[i].empty()) {
                      ...
                      if (o)
                        if ((r.ch == o.length && (r = new it(r.line, r.ch - 1)), r.ch > 0))
                  ...
                  R(t).focus(),
                    ...
                    (i &&
                      (function (e, t, n, i, r) {
                        ...
                        return ca(
                          e,
                          Qo((o = (1 == t ? 'Left' : 2 == t ? 'Middle' : 'Right') + o), r),
                          r,
                          function (t) {
                      ...
                      (1 == r
                        ? i
                          ? (function (e, t, n, i) {
                              ...
                              'single' == n &&
                              (r = u.contains(t)) > -1 &&
                              (rt((r = u.ranges[r]).from(), t) < 0 || t.xRel > 0) &&
                                    ...
                                    i.addNew
                                      ? -1 == s
                                        ...
                                        : c.length > 1 &&
                                            ...
                                            'char' == i.unit &&
                                            !i.extend
                                          ? (io(o, Er(e, c.slice(0, s).concat(c.slice(s + 1)), 0), {
                                              scroll: !1,
                                              origin: '*mouse'
                                            }),
                                            (u = o.sel))
                                          : eo(o, s, l, G)
                                      : ((s = 0), io(o, new Fr([l], 0), G), (u = o.sel));
                                    var h = n;
                                    function f(t) {
                                      if (0 != rt(h, t))
                                        if (((h = t), 'rectangle' == i.unit)) {
                                          for (
                                            var r = [],
                                              a = e.options.tabSize,
                                              c = W(Ke(o, n.line).text, n.ch, a),
                                              d = W(Ke(o, t.line).text, t.ch, a),
                                              f = Math.min(c, d),
                                              p = Math.max(c, d),
                                            ...
                                            var v = Ke(o, m).text,
                                              x = X(v, f, a);
                                            f == p
                                              ? r.push(new Ar(it(m, x), it(m, x)))
                                              : v.length > x &&
                                                r.push(new Ar(it(m, x), it(m, X(v, p, a))));
                                          }
                                          ...
                                          var y,
                                            ...
                                            C = b.anchor;
                                          rt(D.anchor, C) > 0
                                            ? ((y = D.head), (C = st(b.from(), D.anchor)))
                                            : ((y = D.anchor), (C = lt(b.to(), D.head)));
                                    ...
                                    function g(t) {
                                      ...
                                      if (a)
                                        if (0 != rt(a, h)) {
                                          ...
                                          var s =
                                            t.clientY < p.top ? -20 : t.clientY > p.bottom ? 20 : 0;
                                          s &&
                                            setTimeout(
                                              ir(e, function () {
                        ...
                        : 2 == r
                          ...
                          : 3 == r && (k ? t.display.input.onContextMenu(e) : Fi(t)));
                }
            }
            function Da(e, t, n) {
            ...
            function Ca(e, t, n, i) {
              ...
              for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
                ...
                if (u && u.getBoundingClientRect().right >= r)
                  return ve(e, n, e, et(e.doc, o), e.display.gutterSpecs[s].className, t), ke(t);
              }
            }
            function wa(e, t) {
              ...
              (function (e) {
                ...
                pe(t.scroller, 'touchstart', function (r) {
                  if (!xe(e, r) && !o(r) && !wa(e, r)) {
                    ...
                    var a = +new Date();
                    (t.activeTouch = { start: a, moved: !1, prev: a - i.end <= 300 ? i : null }),
                      1 == r.touches.length &&
                      ...
                      (o =
                        !i.prev || s(i, i.prev)
                          ...
                          : !i.prev.prev || s(i, i.prev.prev)
                            ? e.findWordAt(a)
                            : new Ar(it(a.line, 0), ct(e.doc, it(a.line + 1, 0)))),
            ...
            function Na(e, t, n, i) {
              ...
              if (i || /\S/.test(l.text)) {
                if (
                  'smart' == n &&
                  ((u = o.mode.indent(r, l.text.slice(c.length), l.text)) == U || u > 150)
                ) {
                  if (!i) return;
                  n = 'prev';
                }
              ...
              if ((h < u && (d += Z(u - h)), d != c))
                return yo(o, d, it(t, 0), it(t, c.length), '+input'), (l.stateAfter = null), !0;
              ...
              for (var d = e.curOp.updateInput, h = i.ranges.length - 1; h >= 0; h--) {
                ...
                f.empty() &&
                  (n && n > 0
                    ? (p = it(p.line, p.ch - n))
                    : e.state.overwrite && !l
                      ? (m = it(m.line, Math.min(Ke(o, m.line).text.length, m.ch + Y(s).length)))
                      : l &&
                        Oa &&
                        Oa.lineWise &&
                        Oa.text.join('\n') == s.join('\n') &&
                ...
                for (var n = e.doc.sel, i = n.ranges.length - 1; i >= 0; i--) {
                  ...
                  if (!(r.head.ch > 100 || (i && n.ranges[i - 1].head.line == r.head.line))) {
                    ...
                    if (o.electricChars) {
                      ...
                      o.electricInput &&
                        o.electricInput.test(Ke(e.doc, r.head.line).text.slice(0, r.head.ch)) &&
                        (a = Na(e, r.head.line, 'smart'));
              ...
              function u(o) {
                ...
                if ('codepoint' == i) {
                  ...
                  if (isNaN(c)) a = null;
                    ...
                    a = new it(
                      t.line,
                      Math.max(0, Math.min(l.text.length, t.ch + n * (d ? 2 : 1))),
                      -n
                    );
                  }
                } else
                  a = r
                    ? (function (e, t, n, i) {
                        ...
                        if ('rtl' == e.doc.direction || 1 == a.level) {
                          ...
                          if (
                            null != h &&
                            (d ? h <= a.to && h <= c.end : h >= a.from && h >= c.begin)
                          ) {
                        ...
                        var p = function (e, t, i) {
                            for (
                              ...
                              if (((u = l ? a.from : s(a.to, -1)), i.begin <= u && u < i.end))
                                return o(u, l);
                            }
                          },
                          m = p(o + i, i, c);
            ...
            (Ua.prototype.init = function (e) {
              ...
              (Ua.prototype.pollContent = function () {
                ...
                a.line == r.viewFrom || 0 == (e = fi(i, a.line))
                  ...
                  : ((t = Je(r.view[e].line)), (n = r.view[e - 1].node.nextSibling));
                var s,
                  u,
                  c = fi(i, l.line);
                if (
                  (c == r.view.length - 1
                    ...
                    : ((s = Je(r.view[c + 1].line) - 1), (u = r.view[c + 1].node.previousSibling)),
                  !n)
                )
                  return !1;
                for (
                ...
                if (1 == d.length && 1 == h.length && t == a.line)
                  for (
                    ...
                    f &&
                    f > a.ch &&
                    x.charCodeAt(x.length - p - 1) == y.charCodeAt(y.length - p - 1);
            ...
            (Ka.prototype.init = function (e) {
              ...
              function o(e) {
                if (!xe(i, e)) {
                  if (i.somethingSelected()) Ia({ lineWise: !1, text: i.getSelections() });
                  else {
                    if (!i.options.lineWiseCopyCut) return;
                    var t = Pa(i);
                    Ia({ lineWise: !0, text: t.text }),
                      'cut' == e.type
                        ...
                        : ((n.prevInput = ''), (r.value = t.text.join('\n')), z(r));
                  }
                ...
                (e.prototype = {
                  ...
                  removeOverlay: rr(function (e) {
                    for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
                      ...
                      if (i == e || ('string' == typeof e && i.name == e))
                        return t.splice(n, 1), this.state.modeGen++, void pi(this);
                    }
                  }),
                  ...
                  heightAtLine: function (e, t, n) {
                    ...
                    if ('number' == typeof e) {
                      ...
                      e < this.doc.first ? (e = this.doc.first) : e > o && ((e = o), (r = !0)),
                        (i = Ke(this.doc, e));
                    } else i = e;
                    return (
                      Vn(this, i, { top: 0, left: 0 }, t || 'page', n || r).top +
                      (r ? this.doc.height - Gt(i) : 0)
                    );
                  },
                  ...
                  addWidget: function (e, t, n, i, r) {
                    ...
                    if (
                      ...
                      ('above' == i || e.bottom + t.offsetHeight > d) && e.top > t.offsetHeight
                    ...
                    (t.style.top = u + 'px'),
                      ...
                      'right' == r
                        ...
                        : ('left' == r
                            ? (c = 0)
                            : 'middle' == r && (c = (s.sizer.clientWidth - t.offsetWidth) / 2),
                          (t.style.left = c + 'px')),
                      n &&
                        ((o = this),
                        (a = {
                  ...
                  findPosV: function (e, t, n, i) {
                    ...
                    for (var a = ct(this.doc, e), l = 0; l < t; ++l) {
                      var s = Zn(this, a, 'div');
                      if (
                        (null == o ? (o = s.left) : (s.left = o), (a = qa(this, s, r, n)).hitSide)
                      )
                        break;
                    }
                    return a;
                  ...
                  moveV: rr(function (e, t) {
                    ...
                    if (
                      (i.extendSelectionsBy(function (a) {
                        ...
                        var s = qa(n, l, e, t);
                        return (
                          'page' == t && a == i.sel.primary() && Ni(n, Kn(n, s, 'div').top - l.top),
                          s
                        );
                      }, V),
                      r.length)
      ...
      11: [
        ...
        { '../../addon/mode/overlay': 7, '../../lib/codemirror': 10, '../markdown/markdown': 12 }
      ],
      12: [
        function (e, t, n) {
          var i;
              ...
              function (t, n) {
                    ...
                    : r.setext ||
                      ...
                      ? (r.setext
                          ? ((r.header = r.setext),
                            ...
                            i.skipToEnd(),
                            n.highlightFormatting && (r.formatting = 'header'))
                          : ((r.header = '=' == F[0].charAt(0) ? 1 : 2), (r.setext = r.header)),
                        (r.thisLine.header = !0),
                        (r.f = r.inline),
                        C(r))
                      : S
                ...
                function D(e, t) {
                  var i,
                    ...
                    a = t.indentation < r,
                    l = r + 3;
                  return t.fencedEndRE && t.indentation <= l && (a || e.match(t.fencedEndRE))
                    ...
                    for (var i = 0; i < e.formatting.length; i++)
                      t.push(o.formatting + '-' + e.formatting[i]),
                        'header' === e.formatting[i] &&
                          t.push(o.formatting + '-' + e.formatting[i] + '-' + e.header),
                        'quote' === e.formatting[i] &&
                          (!n.maxBlockquoteDepth || n.maxBlockquoteDepth >= e.quote
                            ? t.push(o.formatting + '-' + e.formatting[i] + '-' + e.quote)
                            : t.push('error'));
                  }
                ...
                function k(t, r) {
                  ...
                  if (r.taskList)
                    return (
                      ' ' === t.match(u, !0)[1] ? (r.taskOpen = !0) : (r.taskClosed = !0),
                      n.highlightFormatting && (r.formatting = 'task'),
                      (r.taskList = !1),
                      C(r)
                    );
                  if (((r.taskOpen = !1), (r.taskClosed = !1), r.header && t.match(/^#+$/, !0)))
                    return n.highlightFormatting && (r.formatting = 'header'), C(r);
                  var l = t.next();
                  if (r.linkTitle) {
                    r.linkTitle = !1;
                    var s = l;
                  ...
                  if ('[' === l && !r.image)
                    return (
                      (r.linkText && t.match(/^.*?\]/)) ||
                        ((r.linkText = !0), n.highlightFormatting && (r.formatting = 'link')),
                      C(r)
                    );
                  if (']' === l && r.linkText) {
                  ...
                  if ('*' === l || '_' === l) {
                    for (
                      var D = 1, w = 1 == t.pos ? ' ' : t.string.charAt(t.pos - 2);
                      D < 3 && t.eat(l);
                    ...
                    if (
                      (D % 2 &&
                        (r.em || !E || ('*' !== l && L && !m.test(w))
                          ? r.em != l || !L || ('*' !== l && E && !m.test(A)) || (T = !1)
                          : (T = !0)),
                      D > 1 &&
                        (r.strong || !E || ('*' !== l && L && !m.test(w))
                          ? r.strong != l || !L || ('*' !== l && E && !m.test(A)) || (M = !1)
                          : (M = !0)),
                      null != M || null != T)
                    )
                      return (
                        n.highlightFormatting &&
                          (r.formatting = null == T ? 'strong' : null == M ? 'em' : 'strong em'),
                        !0 === T && (r.em = l),
                        !0 === M && (r.strong = l),
                        (f = C(r)),
                        !1 === T && (r.em = !1),
          ...
          (function (e) {
            ...
            e.defineMode('xml', function (i, r) {
              ...
              function h(e, t) {
                ...
                if ('>' == r || ('/' == r && e.eat('>')))
                  return (
                    (t.tokenize = d), (o = '>' == r ? 'endTag' : 'selfcloseTag'), 'tag bracket'
                  );
                ...
                if ('word' == e) {
                  ...
                  return (
                    n.context &&
                      ...
                      v(n),
                    (n.context && n.context.tagName == i) || !1 === s.matchClosing
                      ? ((a = 'tag'), C)
                      : ((a = 'tag error'), w)
                  );
                }
              ...
              function k(e, t, n) {
                ...
                if ('endTag' == e || 'selfcloseTag' == e) {
                  ...
                  return (
                    ...
                    'selfcloseTag' == e || s.autoSelfClosers.hasOwnProperty(m(i))
                      ? x(n, i)
      ...
      15: [
        function (e, t, n) {
          !(function (e, i) {
            'object' == typeof n && void 0 !== t
              ? i(n)
              : i(((e = 'undefined' != typeof globalThis ? globalThis : e || self).marked = {}));
          })(this, function (e) {
            'use strict';
            function t(e, t) {
              for (var n = 0; n < t.length; n++) {
                  ...
                  (n.link = function (e) {
                    ...
                    if (t) {
                      ...
                      return (
                        ...
                        /^</.test(a) &&
                          (a =
                            this.options.pedantic && !/>$/.test(n) ? a.slice(1) : a.slice(1, -1)),
                        L(
                          t,
                          {
                  ...
                  (n.autolink = function (e, t) {
                    ...
                    if (r)
                      return (
                        (i =
                          '@' === r[2]
                            ? 'mailto:' + (n = d(this.options.mangle ? t(r[1]) : r[1]))
                            : (n = d(r[1]))),
                        {
                          type: 'link',
                          raw: r[0],
            ...
            var I = (function () {
                ...
                return (
                    ...
                    for (
                      ...
                      if (
                        ...
                        if ((n = this.tokenizer.space(e)))
                          ...
                          (e = e.substring(n.raw.length)),
                            !(i = t[t.length - 1]) || ('paragraph' !== i.type && 'text' !== i.type)
                              ? t.push(n)
                              : ((i.raw += '\n' + n.raw),
                                (i.text += '\n' + n.text),
                          ...
                          this.options.extensions &&
                            ...
                            (function () {
                              ...
                              a.options.extensions.startBlock.forEach(function (e) {
                                'number' == typeof (i = e.call({ lexer: this }, n)) &&
                                  i >= 0 &&
                                  (t = Math.min(t, i));
                              }),
                  ...
                  (a.inline = function (e, t) {
                    return (
                      void 0 === t && (t = []), this.inlineQueue.push({ src: e, tokens: t }), t
                    );
                  }),
                    ...
                    for (; e; )
                      if (
                        ...
                        if ((n = this.tokenizer.escape(e)))
                          ...
                          (e = e.substring(n.raw.length)),
                            (i = t[t.length - 1]) && 'text' === n.type && 'text' === i.type
                      ...
                      if (
                        ...
                        switch (d.type) {
                          ...
                          case 'code':
                            ...
                            continue;
                          case 'table':
                            for (u = '', s = '', o = d.header.length, i = 0; i < o; i++)
                              s += this.renderer.tablecell(this.parseInline(d.header[i].tokens), {
                                header: !0,
                                align: d.align[i]
                              });
                            for (
                              u += this.renderer.tablerow(s), c = '', o = d.rows.length, i = 0;
                              i < o;
                              i++
                            ) {
                              for (s = '', a = (l = d.rows[i]).length, r = 0; r < a; r++)
                            ...
                            for (
                              ...
                              (x = (v = d.items[i]).checked),
                                ...
                                v.task &&
                                  ...
                                  m
                                    ? v.tokens.length > 0 && 'paragraph' === v.tokens[0].type
                                      ? ((v.tokens[0].text = b + ' ' + v.tokens[0].text),
                                        v.tokens[0].tokens &&
                                          v.tokens[0].tokens.length > 0 &&
                                          'text' === v.tokens[0].tokens[0].type &&
                                          (v.tokens[0].tokens[0].text =
                                            b + ' ' + v.tokens[0].tokens[0].text))
                                      : v.tokens.unshift({ type: 'text', text: b })
                                    : (g += b)),
            ...
            (_.options = _.setOptions =
              ...
              (_.use = function () {
                ...
                var i,
                  ...
                  o = _.defaults.extensions || { renderers: {}, childTokens: {} };
                t.forEach(function (e) {
                  if (
                    ...
                    r.walkTokens = function (n) {
                      var i = [];
                      return (
                        i.push(e.walkTokens.call(this, n)), t && (i = i.concat(t.call(this, n))), i
                      );
                    };
                  }
                      ...
                      switch (((r = r.concat(t.call(_, e))), e.type)) {
                        ...
                        default:
                          ...
                          _.defaults.extensions.childTokens[e.type]
                            ? _.defaults.extensions.childTokens[e.type].forEach(function (n) {
                    ...
                    e &&
                      ...
                      t && i
                        ...
                        : 'undefined' != typeof window &&
                          ...
                          ? ((o = r.dictionaryPath ? r.dictionaryPath : 'typo/dictionaries'),
                            t || d(chrome.extension.getURL(o + '/' + e + '/' + e + '.aff'), h),
                            i || d(chrome.extension.getURL(o + '/' + e + '/' + e + '.dic'), f))
                          : ((o = r.dictionaryPath
                              ? r.dictionaryPath
                              : void 0 !== n
                                ? n + '/dictionaries'
                        ...
                        if ('PFX' == d || 'SFX' == d) {
                          ...
                          for (o = r + 1, l = r + 1 + (n = parseInt(c[3], 10)); o < l; o++) {
                            ...
                            (b.add = v),
                              ...
                              '.' !== y &&
                                (b.match = 'SFX' === d ? new RegExp(y + '$') : new RegExp('^' + y)),
                              '0' != m && (b.remove = 'SFX' === d ? new RegExp(m + '$') : m),
                              p.push(b);
                          }
                          (s[h] = { type: d, combineable: 'Y' == f, entries: p }), (r += n);
                        } else if ('COMPOUNDRULE' === d) {
                          for (o = r + 1, l = r + 1 + (n = parseInt(c[1], 10)); o < l; o++)
                            (i = (t = u[o]).split(/\s+/)), this.compoundRules.push(i[1]);
                          r += n;
                        } else
                          'REP' === d
                    ...
                    for (var r = 1, o = t.length; r < o; r++) {
                      ...
                      if (a) {
                        ...
                        if (l.length > 1) {
                          ...
                          ('NEEDAFFIX' in this.flags && -1 != u.indexOf(this.flags.NEEDAFFIX)) ||
                            i(s, u);
                                ...
                                if ((i(v, []), f.combineable))
                                  for (var x = c + 1; x < d; x++) {
                                    ...
                                    if (b && b.combineable && f.type != b.type)
                                      for (
                                        var D = this._applyRule(v, b), C = 0, w = D.length;
                                        C < w;
                                        C++
                                      ) {
                                        i(D[C], []);
                      ...
                      for (var u in e)
                        for (n = 0, r = u.length + 1; n < r; n++) {
                          ...
                          if (
                            ...
                            c[1].length > 1 &&
                              c[1][1] !== c[1][0] &&
                              ((o = c[0] + c[1][1] + c[1][0] + c[1].substring(2)),
                              (t && !l.check(o)) || (o in a ? (a[o] += 1) : (a[o] = 1))),
                            c[1])
                          ) {
                            var d =
                              c[1].substring(0, 1).toUpperCase() === c[1].substring(0, 1)
                                ? 'uppercase'
                                : 'lowercase';
                            for (i = 0; i < s; i++) {
                              var h = l.alphabet[i];
                          ...
                          if (c[1])
                            for (i = 0; i < s; i++) {
                              (d =
                                c[0].substring(-1).toUpperCase() === c[0].substring(-1) &&
                                c[1].substring(0, 1).toUpperCase() === c[1].substring(0, 1)
                                  ? 'uppercase'
                                  : 'lowercase'),
                                (h = l.alphabet[i]);
                    ...
                    return (
                      ...
                      (this.memoized[e] = {
                        suggestions: (function (e) {
                          ...
                          e.toUpperCase() === e
                            ? (c = 'uppercase')
                            : e.substr(0, 1).toUpperCase() + e.substr(1).toLowerCase() === e &&
                              (c = 'capitalized');
                          var d = t;
                          for (n = 0; n < Math.min(d, a.length); n++)
                            'uppercase' === c
                              ...
                              : 'capitalized' === c &&
                                (a[n][0] = a[n][0].substr(0, 1).toUpperCase() + a[n][0].substr(1)),
                              l.hasFlag(a[n][0], 'NOSUGGEST') || -1 != u.indexOf(a[n][0])
                                ? d++
                                : u.push(a[n][0]);
                          return u;
                        })(e),
        ...
        function (e, t, n) {
          ...
          function m(e, t) {
            ...
            for (var i, r, o = n.type.split(' '), a = {}, l = 0; l < o.length; l++)
              'strong' === (i = o[l])
                ...
                : 'variable-2' === i
                  ? ((r = e.getLine(t.line)),
                    /^\s*\d+\.\s/.test(r) ? (a['ordered-list'] = !0) : (a['unordered-list'] = !0))
                  : 'atom' === i
                    ? (a.quote = !0)
                    : 'em' === i
                      ? (a.italic = !0)
          ...
          function D(e) {
            ...
            function r(e, t, r, o, a) {
              (r = r || e.getLineHandle(t)),
                ...
                (a = a || (!!r.text && e.getTokenAt({ line: t, ch: r.text.length - 1 })));
              var l = o.type ? o.type.split(' ') : [];
              return a && i(a).indentedCode
                ? 'indented'
                : -1 !== l.indexOf('comment') &&
                    (i(o).fencedChars || i(a).fencedChars || n(r) ? 'fenced' : 'single');
            }
            var o,
              a,
              l,
            ...
            if ('single' === f) {
              ...
              s.replaceRange(p + m, { line: u.line, ch: 0 }, { line: u.line, ch: 99999999999999 }),
                u.ch--,
                u !== c && c.ch--,
                s.setSelection(u, c),
                s.focus();
              ...
              if (u.line !== c.line || u.ch !== c.ch) {
                ...
                n(s.getLineHandle(u.line))
                  ...
                  s.operation(function () {
                    s.replaceRange(x, { line: y, ch: 0 }, { line: y + (x ? 0 : 1), ch: 0 }),
                      s.replaceRange(g, { line: v, ch: 0 }, { line: v + (g ? 0 : 1), ch: 0 });
                  }),
                  s.setSelection(
                    { line: v + (g ? 1 : 0), ch: 0 },
                    { line: y + (g ? 1 : -1), ch: 0 }
                ...
                s.operation(function () {
                  s.replaceRange('', { line: o, ch: 0 }, { line: o + 1, ch: 0 }),
                    s.replaceRange('', { line: a - 1, ch: 0 }, { line: a, ch: 0 });
                }),
                  s.focus();
              }
            else if ('indented' === f) {
            ...
            !(function (e) {
              ...
              for (
                ...
                (t = (t = e.getLine(r)).replace(/^[ ]*([# ]+|\*|-|[> ]+|[0-9]+(.|\)))[ ]*/, '')),
                  e.replaceRange(t, { line: r, ch: 0 }, { line: r, ch: 99999999999999 });
            })(e.codemirror);
          }
          function O(e) {
            var t = e.options,
          ...
          function U(e) {
            var t = e.codemirror,
              ...
              o = n.lastChild;
            if (
              (t.getWrapperElement().nextSibling.classList.contains('editor-preview-active-side') &&
                q(e),
              !o || !o.classList.contains('editor-preview-full'))
            ) {
              if (
                (((o = document.createElement('div')).className = 'editor-preview-full'),
            ...
            o.classList.contains('editor-preview-active')
              ? (o.classList.remove('editor-preview-active'),
                r && (r.classList.remove('active'), i.classList.remove('disabled-for-preview')))
              : (setTimeout(function () {
                  o.classList.add('editor-preview-active');
                }, 1),
                r && (r.classList.add('active'), i.classList.add('disabled-for-preview')));
          ...
          function G(e, t, n) {
            if (!e.getWrapperElement().lastChild.classList.contains('editor-preview-active')) {
              for (
                var i = e.getCursor('start'), r = e.getCursor('end'), o = i.line;
                o <= r.line;
                o++
              )
                !(function (i) {
                  ...
                  (r =
                    ...
                    e.replaceRange(r, { line: i, ch: 0 }, { line: i, ch: 99999999999999 });
                })(o);
              e.focus();
            }
          }
            ...
            if (!e.getWrapperElement().lastChild.classList.contains('editor-preview-active')) {
              for (
                var i = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
                  ...
                  a = e.getCursor('start'),
                  l = e.getCursor('end'),
                  s = { quote: /^(\s*)>\s+/, 'unordered-list': i, 'ordered-list': i },
                  u = function (e, t, o) {
                    var a = i.exec(t),
                      l = (function (e, t) {
                        return { quote: '>', 'unordered-list': n, 'ordered-list': '%%i.' }[
                          e
                        ].replace('%%i', t);
                      })(e, c);
                    return (
                      null !== a
                        ? ((function (e, t) {
                            var i = new RegExp(
                              { quote: '>', 'unordered-list': '\\' + n, 'ordered-list': '\\d+.' }[e]
                            );
                            return t && i.test(t);
                          })(e, a[2]) && (l = ''),
                          (t = a[1] + l + a[3] + t.replace(r, '').replace(s[e], '$1')))
                        : 0 == o && (t = l + ' ' + t),
                      t
                    );
                  },
                ...
                !(function (n) {
                  ...
                  o[t]
                    ...
                    : ('unordered-list' == t && (i = u('ordered-list', i, !0)),
                      (i = u(t, i, !1)),
                      (c += 1)),
                    e.replaceRange(i, { line: n, ch: 0 }, { line: n, ch: 99999999999999 });
                })(d);
              e.focus();
            }
          }
          ...
          var ee = {
            ...
            te = {
              bold: { name: 'bold', action: x, className: ee.bold, title: 'Bold', default: !0 },
              italic: {
                name: 'italic',
                action: y,
                className: ee.italic,
              ...
              code: { name: 'code', action: D, className: ee.code, title: 'Code' },
              quote: { name: 'quote', action: C, className: ee.quote, title: 'Quote', default: !0 },
              'unordered-list': {
                name: 'unordered-list',
                action: M,
              ...
              table: { name: 'table', action: P, className: ee.table, title: 'Insert Table' },
              'horizontal-rule': {
              ...
              undo: { name: 'undo', action: W, className: ee.undo, noDisable: !0, title: 'Undo' },
              redo: { name: 'redo', action: j, className: ee.redo, noDisable: !0, title: 'Redo' }
            },
            ne = {
              link: ['[', '](#url#)'],
              image: ['![', '](#url#)'],
            ...
            re = { locale: 'en-US', format: { hour: '2-digit', minute: '2-digit' } },
            oe = { bold: '**', code: '```', italic: '*' },
            ae = {
          ...
          function se(e) {
            ...
            if (
              ...
              (e.parsingConfig = Q({ highlightFormatting: !0 }, e.parsingConfig || {})),
              (e.insertTexts = Q({}, ne, e.insertTexts || {})),
              (e.promptTexts = Q({}, ie, e.promptTexts || {})),
              (e.blockStyles = Q({}, oe, e.blockStyles || {})),
              null != e.autosave &&
                (e.autosave.timeFormat = Q({}, re, e.autosave.timeFormat || {})),
          ...
          (se.prototype.uploadImages = function (e, t, n) {
            if (0 !== e.length) {
              ...
              this.updateStatusBar(
                'upload-image',
                this.options.imageTexts.sbOnDrop.replace('#images_names#', i.join(', '))
              );
            }
          }),
            ...
            (se.prototype.markdown = function (e) {
              if (o) {
                ...
                return (
                  this.options.renderingConfig &&
                    'function' == typeof this.options.renderingConfig.sanitizerFunction &&
                    (i = this.options.renderingConfig.sanitizerFunction.call(this, i)),
                  (i = (function (e) {
                    for (
                      ...
                      for (var r = n[i], o = 0; o < r.children.length; o++) {
                        ...
                        a instanceof HTMLInputElement &&
                          'checkbox' === a.type &&
                          ((r.style.marginLeft = '-1.5em'), (r.style.listStyleType = 'none'));
                      }
              ...
              if (
                ...
                if (
                  ...
                  o.overlayMode
                    ? (i.defineMode('overlay-mode', function (e) {
                        return i.overlayMode(
                          i.getMode(e, !1 !== o.spellChecker ? 'spell-checker' : 'gfm'),
                          o.overlayMode.mode,
                  ...
                  (this.codemirror = i.fromTextArea(e, {
                    ...
                    inputStyle:
                      null != o.inputStyle ? o.inputStyle : c() ? 'contenteditable' : 'textarea',
                  ...
                  void 0 !== o.maxHeight &&
                    (this.codemirror.getScrollerElement().style.height = o.maxHeight),
                  !0 === o.forceSync)
                ) {
                ...
                this.codemirror.on('update', function () {
                  o.previewImagesInEditor &&
                    f.querySelectorAll('.cm-image-marker').forEach(function (e) {
            ...
            (se.prototype.autosave = function () {
              if (ue()) {
                ...
                var t = e.value();
                '' !== t
                  ? localStorage.setItem('smde_' + this.options.autosave.uniqueId, t)
            ...
            (se.prototype.uploadImage = function (e, t, n) {
              ...
              if (
                ...
                (l.upload.onprogress = function (t) {
                  ...
                  i.options.imageCSRFToken &&
                    i.options.imageCSRFHeader &&
                    l.setRequestHeader(i.options.imageCSRFName, i.options.imageCSRFToken),
                  (l.onload = function () {
                    try {
                    ...
                    200 === this.status && e && !e.error && e.data && e.data.filePath
                      ? t(
                          (i.options.imagePathAbsolute ? '' : window.location.origin + '/') +
                            e.data.filePath
                        )
                ...
                function (e) {
                  var i = (function (e) {
                    ...
                    return e
                      ...
                      .replace('#image_max_size#', Z(n.options.imageMaxSize, i));
                  })(e);
            ...
            (se.prototype.createSideBySide = function () {
              ...
              if (!n || !n.classList.contains('editor-preview-side')) {
                if (
                  (((n = document.createElement('div')).className = 'editor-preview-side'),
              ...
              if (
                (void 0 !== this.options.maxHeight && this.setPreviewMaxHeight(),
              ...
              if ((e = e || this.options.toolbar) && 0 !== e.length) {
                ...
                for (i.toolbar = e, t = 0; t < e.length; t++)
                  if (
                    ...
                    !(
                      (i.options.hideIcons && -1 != i.options.hideIcons.indexOf(e[t].name)) ||
                      (('fullscreen' == e[t].name || 'side-by-side' == e[t].name) && c())
                    )
                  ) {
                    if ('|' === e[t]) {
                      for (var o = !1, a = t + 1; a < e.length; a++)
                        '|' === e[a] ||
                          (i.options.hideIcons && -1 != i.options.hideIcons.indexOf(e[a].name)) ||
                          (o = !0);
                      if (!o) continue;
                    }
                    !(function (e) {
                      ...
                      if (
                        ((t =
                          '|' === e
                            ? p()
                            : e.children
                              ? h(e, i.options.toolbarTips, i.options.shortcuts, i)
                              : f(e, !0, i.options.toolbarTips, i.options.shortcuts, 'button', i)),
                        (r[e.name || e] = t),
                        n.appendChild(t),
                        'upload-image' === e.name)
                      ) {
                  ...
                  for (var t in r)
                    !(function (t) {
                      ...
                      e[t]
                        ...
                        : 'fullscreen' != t && 'side-by-side' != t && n.classList.remove('active');
                    })(t);
                });
            ...
            (se.prototype.createStatusbar = function (e) {
              ...
              if (e && 0 !== e.length) {
                ...
                for (i = 0; i < e.length; i++)
                  if (((r = void 0), (o = void 0), (a = void 0), 'object' == typeof e[i]))
                    l.push({
                    ...
                    'words' === s
                      ...
                      l.push({ className: s, defaultValue: a, onUpdate: r, onActivity: o });
                  }
